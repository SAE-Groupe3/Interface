...
<section class="container mx-auto px-6 md:px-12 py-12 mt-12">
    <div class="text-center mb-12">
        <h1 class="text-4xl md:text-5xl font-bold text-indigo-900 mb-4" data-aos="fade-down">
            Bienvenue dans l'application de gestion des stages
        </h1>
        <p class="text-gray-600 text-lg" data-aos="fade-up">
            Cette application vous aide à gérer les stages des étudiants, suivre leur progression et faciliter la communication entre les différents acteurs.
        </p>
    </div>
...
<section id="faq" class="bg-gray-100 py-12 pb-12" data-aos="fade-up">
    <div class="container mx-auto px-6 md:px-12">
        <h2 class="text-3xl font-bold text-indigo-900 text-center mb-8">FAQ - Questions Fréquentes</h2>
